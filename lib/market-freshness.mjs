import { SEO_MODEL_VERSION, MARKET_FRESHNESS_MODEL_VERSION } from './model-versions.mjs';
...
export function analyzeMarketFreshness(candidate = {}, nowMs = Date.now()) {
  ...
  const competitionChecked = Boolean(
    seo.modelVersion === SEO_MODEL_VERSION
    && !seo.provisional
  ...
  return {
    modelVersion: MARKET_FRESHNESS_MODEL_VERSION,
