...
const SET_MEMBERS = {
  ...
  FAST_WIKI_HIGH_QUALITY: [
    'steam-top-wishlist', 'steam-popular-new', 'steam-new', 'itch-featured', 'steam-upcoming', 'press-new',
  ],
  ...
  SERPER_WIKI_STRATEGIC: [
    ...
    'competitor-sitemap', 'steam-upcoming', 'press-new',
  ],
  ...
  // scripts/verify-google-cse.mjs — not invoked by .github/workflows/radar.yml
  // (the Google CSE path was superseded by Serper). Kept in the table so the
  // "no source-tag sets outside this file" guard holds repo-wide, and flagged in
  // the review report as a candidate for deletion. Matched on kind only.
  GOOGLE_CSE_STRATEGIC: [
    'trends-rising-7d', 'trends-rising-30d', 'itch-featured', 'itch-popular',
